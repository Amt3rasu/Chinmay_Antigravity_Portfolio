...
import { caseStudyScreens } from './caseStudyData'
...
export function Computers(props) {
    ...
    return (
        <group {...props} dispose={null}>
            ...
            {/* Mapped Screens using Case Study Data */}
...
const Screen = React.forwardRef(({ frame, panel, children, ...props }, ref) => {
...
function ScreenText({ caseStudy, frame, panel, x = 0, y = 1.2, staggerIndex = 0, ...props }) {
