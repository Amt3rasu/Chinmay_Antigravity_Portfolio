...
/*
 * NON-DESTRUCTIVE CLONE of App.jsx
 * The ONLY change is: eventSource is passed as a prop instead of
 * hardcoding document.getElementById('root'), so we can scope pointer
 * events to the monitor section container when embedded in a page.
 *
...
export default function SimulationApp({ eventSource }) {
    return (
        <Canvas
            shadows
            dpr={[1, 1.5]}
            camera={{ position: [-1.5, 1, 5.5], fov: 45, near: 1, far: 20 }}
            eventSource={eventSource || document.getElementById('root')}
            eventPrefix="offset"
        >
            {/* Lights */}
